...
const projects = [
    { title: "Прогнозирование заболеваний", area: "медицина", description: "Использование машинного обучения для ранней диагностики заболеваний на основе медицинских данных.", image: "img/1.jpg" },
    ...
    { title: "Система безопасности для предприятий", area: "безопасность", description: "Разработка AI систем для анализа угроз и предотвращения кибератак.", image: "img/5.jpg" },

    { title: "Мониторинг состояния окружающей среды", area: "экология", description: "Применение ИИ для анализа экологических данных и прогноза изменений экосистем.", image: "img/6.jpg" },
    { title: "Анализ больших данных для бизнеса", area: "data-science", description: "Использование методов машинного обучения для превращения данных в стратегические решения.", image: "img/7.jpg" },
...
function displayProjects(filteredProjects) {
    ...
    filteredProjects.forEach(project => {
        ...
        projectDiv.innerHTML = ` <h3>${project.title}</h3> <img src="${project.image}" alt="${project.title}"> `;

        projectDiv.appendChild(descriptionParagraph); 
        projectDiv.innerHTML += '<a href="#" class="btn">Подробнее</a>';
